...
public final class ZipUtil {
    ...
    public static void ZipFolder(String srcFileString, String zipFileString) throws Exception {
        //创建ZIP
        ZipOutputStream outZip = new ZipOutputStream(Files.newOutputStream(Paths.get(zipFileString)));
        //创建文件
     ...
     * @throws Exception
     */
    public static void fileToZip(String sourceFilePath, String path) throws Exception {
        fileToZip(new File(sourceFilePath), path);
    }
     ...
     * @throws Exception
     */
    public static void fileToZip(File sourceFile, String toPath) throws Exception {
