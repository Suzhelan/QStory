...
public class OutputHookStack {
     ...
     * 输出的日志路径 需要以/结尾的路径
     */
    private static final String OUTPUT_LOG_DIR = PathInit.paths[0];
    ...
    public static void OutputObjectField(Object obj) {
        ...
        writeTextToFile(OUTPUT_LOG_DIR + "对象反射记录/" + ThisClass.getName() + ".java", stringBuffer.toString(), true);
    }
    ...
    public static void OutputStaticMethodStack(XC_MethodHook.MethodHookParam param) {
        ...
        writeTextToFile(OUTPUT_LOG_DIR + "动态反射记录/" + ThisClass.getName() + "." + param.method.getName() + ".java", stringBuffer.toString(), true);
    }
     ...
     */
    private static void writeTextToFile(String path, String content, boolean isAppend) {
